...
using CapaPresentacionAdministracion.Servicios.FormsCorreoTicket;
using System;
...
namespace CapaPresentacionAdministracion.Controles
{
    public partial class UploadImage : UserControl
    {
        ...
        {
            this.OnBtnQuitarClick?.Invoke(this, e);
        }
        ...
        private void BtnScreenShot_Click(object sender, EventArgs e)
        {
            ...
            this.OnBtnCaptureClick?.Invoke(this, e);
        }
        ...
        {
            Image Imagen = Imagenes.ObtenerImagen(appKey, nombre_imagen, out string rutaOr);
        ...
        private void BtnSeleccionar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OpenFileDialog archivo = new OpenFileDialog
                {
                    ...
                    Filter = "Documentos válidos|*.jpg;*.png;*.jfif"
                };
